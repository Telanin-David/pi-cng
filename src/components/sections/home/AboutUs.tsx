...
export default function AboutUsSection() {
  ...
  return (
    <section className="ds-section bg-[#F6F6F2]">
        ...
        <div className="ds-container mx-auto px-10 md:px-12 lg:px-16">
        {/* ✅ reduce left↔right space on desktop + keep it visually centered */}
        <div className="ds-grid items-start gap-y-8 lg:gap-y-0 lg:gap-x-8 xl:gap-x-30">
            {/* LEFT SUBSECTION */}
            <div className="col-span-12 lg:col-span-6 flex lg:justify-end md:mt-5">
            ...
            {/* RIGHT SUBSECTION */}
            <div className="col-span-12 lg:col-span-6 flex lg:justify-start">
            {/* ✅ remove big padding-left so it sits closer to the left column */}
